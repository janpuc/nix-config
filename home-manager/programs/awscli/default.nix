...
in
{
  ...
  home.file.".aws/saml2aws/DSC/.env".text = ''
    ...
    SAML2AWS_SAML_CACHE_FILE="${config.home.homeDirectory}/.aws/saml2aws/DSC/cache"
  '';

  home.file.".aws/saml2aws/DTC/.env".text = ''
    SAML2AWS_URL="op://${vault}/AWS/DTC"
    SAML2AWS_SAML_CACHE_FILE="${config.home.homeDirectory}/.aws/saml2aws/DTC/cache"
  '';
  ...
  home.file.".aws/saml2aws/WB/.env".text = ''
    ...
    SAML2AWS_SAML_CACHE_FILE="${config.home.homeDirectory}/.aws/saml2aws/WB/cache"
  '';
}
